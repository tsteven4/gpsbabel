...
private:
  ...
  const char* opt_grid{nullptr};
  const char* opt_utc{nullptr};
  const char* opt_filename{nullptr};
  const char* opt_format{nullptr};
  const char* opt_prec{nullptr};
  const char* opt_fields{nullptr};
  const char* opt_codec{nullptr};
  int unicsv_waypt_ct{};
  char unicsv_detect{};
  int llprec{};
