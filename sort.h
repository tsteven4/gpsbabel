...
private:
  ...
  const char* opt_sm_gcid{}, *opt_sm_shortname{}, *opt_sm_description{}, *opt_sm_time{};
  const char* opt_sm_rtenum{}, *opt_sm_rtename{}, *opt_sm_rtedesc{};
  const char* opt_sm_trknum{}, *opt_sm_trkname{}, *opt_sm_trkdesc{};
