...
#include <QtXml/QXmlAttributes>      // for QXmlAttributes
#include <QtXml/QXmlDefaultHandler>  // for QXmlDefaultHandler
#include <QtXml/QXmlInputSource>     // for QXmlInputSource
#include <QtXml/QXmlSimpleReader>    // for QXmlSimpleReader
