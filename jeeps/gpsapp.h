...
int32_t GPS_D300_Get(GPS_PTrack* trk, int32_t entries, GpsDevice* fd);
...
int32_t GPS_A800_Off(GpsDevice* fd);
...
void   GPS_D1011b_Get(GPS_PLap* Lap,UC* p); /*D906 D1001 D1015*/
